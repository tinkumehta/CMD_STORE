  ...
  return (
    <header className="w-full bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-col md:flex-row justify-between items-center border-b border-gray-200">
        ...
        {/* Title */}
        <h1 className="text-xl md:text-2xl font-bold text-blue-800 tracking-wide text-center my-2">
      ...
      <nav className="bg-blue-800 text-white text-sm">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap">
          {['Home', 'About Us', 'Directory', 'Departments', 'Corporate Links', 'Plant Links', 'Other Apps', 'Imp. Link', 'External Links', 'Circulars & Guidelines', 'DOP', 'DSR', 'GCC', 'Manuals & Standards'].map((item) => (
            <Link key={item} to="#" className="px-3 py-2.5 hover:bg-blue-900 transition-colors whitespace-nowrap">
              {item}
            </Link>
          ))}
        </div>
