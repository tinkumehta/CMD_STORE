  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden min-h-[600px]">
        ...
        {/* Left Side - Branding */}
        <div className="md:w-2/5 bg-[#1a2332] p-10 flex flex-col justify-between text-white relative">
          <div className="flex flex-col items-center text-center mt-10">
            {/* Placeholder for NTPC Logo */}
           
             <img src={ntpclogo} alt=""  className='w-20'/>
            <h1 className="text-3xl font-bold mb-4 tracking-wide">SHARED SERVICE SITE C&M 
          </h1>
        ...
        <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-lg hover:bg-blue-700 transition duration-200 flex items-center justify-center gap-2 mt-4"
            >
